...
# FILL THIS IN
# def travel(starting_dir):
#     q = []
#     q.append(starting_dir)
#     visited = []
#     traversalPath = []
# # traversalPath =  ['n','n','s','s','e','e','w','w','s','s','n','n','w','w']
#     while len(q) > 0:
#         roomId = q.pop()
#         print(roomId, 'room_to_loop')
#         if roomId not in visited:
#             for i in roomGraph[roomId][1]:  # roomGraph[roomId][1] == {'n': 1, 's': 5, 'e': 3, 'w': 7}
#                 # print(roomGraph[roomId][1][i])
#                     print(roomGraph[roomId][1][i], 'loop')
#                     visited.append(roomId)
#                     # print(i) #key 
#                     # print(roomGraph[roomId][1][i], 'value')  #value
#                     traversalPath.append(i)
#                     q.append(roomGraph[roomId][1][i])    
#     print(traversalPath)
#     return traversalPath
traversalPath = ['n', 's'] #populate with n/s/e/w
...
while True:
    ...
    # mark every room it went through as seen
...
#     # n or w
    player.travel(move)
    # 3  direction feed into it
    player.currentRoom
    visited_rooms.add(player.currentRoom)


print(len(visited_rooms), 'of', len(roomGraph))
